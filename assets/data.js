...
window.TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      blocks: [
        { t: 'row', spot: 'hotel-ao-kamakura', time: '08:15 出发', kind: 'go', place: 'HOTEL AO KAMAKURA', dur: '▶ 10分' },
        { t: 'row', spot: 'shichirigahama', time: '08:25‒08:45', place: '七里ヶ浜', dur: '▶ 10分' },
        { t: 'row', spot: 'kamakurakokomae', time: '08:50‒09:15', place: '镰仓高校前', note: '江ノ電拍照，每约12分一班', dur: '▶ 10分' },
        { t: 'row', spot: 'enoshima-dropoff', time: '09:20', place: '江の島 下车', note: '上行走エスカー约20分到鱼见亭（扶梯只上不下）' },
        { t: 'row', spot: 'uomitei-queue', time: '09:40', kind: 'fixed', place: '鱼见亭 排队', note: '10:00开门前必须到位', noteWarn: true },
        { t: 'row', spot: 'uomitei-meal', time: '10:00‒11:00', place: '鱼见亭 用餐' },
        { t: 'row', spot: 'enoshima-iwaya', time: '11:10‒11:30', place: '江の島岩屋' },
        { t: 'row', spot: 'chigogafuchi-bentenmaru', time: '11:35‒11:50', place: '稚児ヶ淵 乘 べんてん丸 回弁天橋', note: '约7分，无固定班次，2艘轮流，一般等5〜10分' },
        { t: 'row', spot: 'bentenbashi-pickup', time: '12:00', kind: 'go', place: '弁天橋 本土側 上车 → 热海', note: '船和步行都在同一处上车', dur: '▶ 90分' },
    ...
    },
    {
      ...
      tag: { kind: 'badge', text: '★ 换酒店·装行李' },
      blocks: [
        { t: 'row', spot: 'atami-seaside-resort', time: '08:00 出发', kind: 'go', place: 'Atami Seaside Spa & Resort', note: '赶大室山首班缆车。', dur: '▶ 50分' },
        { t: 'row', spot: 'omuroyama-parking', time: '08:50 到达', kind: 'fixed', place: '大室山 停车场', note: '缆车09:00开始运行，务必开门前排上队', noteWarn: true },
        { t: 'row', spot: 'omuroyama', time: '09:00‒10:15', place: '大室山', note: '缆车单程6分＋火口一周；暑假期间迟到会排30〜60分，中午可达1小时以上', dur: '▶ 5分' },
        { t: 'row', spot: 'izu-shaboten', time: '10:25‒12:25', place: '伊豆シャボテン動物公園', note: '时间可缩短', dur: '▶ 5分' },
    ...
    },
    {
      ...
      blocks: [
        { t: 'row', spot: 'inatoriso', time: '09:30 出发', kind: 'go', place: '稲取荘', note: '前提：8/19 已泡过温泉。石廊崎17:00闭园', dur: '▶ 35分' },
        { t: 'row', spot: 'shirahama-ikona', time: '10:05‒10:45', place: '白浜海岸·伊古奈比咩命神社', dur: '▶ 15分' },
        { t: 'row', spot: 'kuppama', time: '11:00‒11:30', place: '九十浜', dur: '▶ 15分' },
        { t: 'row', spot: 'tsumekizaki', time: '11:45‒12:15', place: '爪木崎', dur: '▶ 20分' },
        { t: 'row', spot: 'shimoda-kurofune', time: '12:35‒14:15', place: '下田 黒船·午餐·下田公园', dur: '▶ 25分' },
        { t: 'row', spot: 'ryugukutsu', time: '14:45‒15:15', place: '竜宮窟', dur: '▶ 15分' },
    ...
    },
    {
      ...
      tag: { kind: 'badge', text: '★ 换酒店·装行李' },
      blocks: [
        { t: 'row', spot: 'inatoriso', time: '08:30 出发', kind: 'go', place: '稲取荘', dur: '▶ 60分' },
        { t: 'row', spot: 'joren-falls', time: '09:30‒10:10', place: '浄蓮の滝', dur: '▶ 10分' },
        { t: 'row', spot: 'amagi-wasabi', time: '10:20‒10:35', place: '天城わさび村', note: '短停，买纪念品，吃冰淇淋', dur: '▶ 15分' },
        { t: 'row', spot: 'juroku-shuzenji', time: '10:50 到店', kind: 'fixed', place: '浅草じゅうろく 修善寺はなれ', note: '11:00开门前排队', noteWarn: true },
        { t: 'row', spot: 'juroku-lunch', time: '11:00‒12:00', place: '午餐', dur: '▶ 10分' },
        { t: 'row', spot: 'shuzenji', time: '12:15‒12:50', place: '修善寺', dur: '▶ 15分' },
    ...
    },
    {
      ...
      blocks: [
        { t: 'row', spot: 'tokyo-day', tall: true, time: '全天', place: '森美術館 / 表参道 / 涩谷（Shibuya Sky 16:40）/ 麻布十番', copy: false, dur: '地铁·步行' }
      ]
    },
    {
      id: 'day9',
